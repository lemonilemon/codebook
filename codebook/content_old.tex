...
%\lstinputlisting{1_Basic/GeometryDefaultFloat.h}
\subsection{.vimrc}
\lstinputlisting{1_Basic/.vimrc}
\subsection{pragma}
\lstinputlisting{1_Basic/pragma.cpp}
\subsection{PBDS}
\lstinputlisting{1_Basic/PBDS.cpp}
\subsection{splitmix64}
\lstinputlisting{1_Basic/spiltmix64.cpp}
...
\subsection{Maximum Clique Dyn*} % test by TIOJ 1978, CF 101221 I (World Finals' problem)
...
\subsection{DMST} % test by NTUJ 2176
\lstinputlisting{2_Graph/Minimum_Arborescence.cpp}
\lstinputlisting{2_Graph/DMST.cpp}
...
\subsection{LiChaoST*} % test by Library Checker Line Add Get Min
...
\subsection{Maximum Simple Graph Matching*} % test by Library Checker Matching on General Graph 
\lstinputlisting{4_Flow_Matching/Maximum_Simple_Graph_Matching.cpp}
\subsection{Maximum Weight Matching*} % test by Library Checker General Weighted Matching
\lstinputlisting{4_Flow_Matching/Maximum_Weight_Matching.cpp}
...
\section{Math}
\subsection{ExtGCD} % exgcd test by NTUJ 110
...
\subsection{Newton's Method + Misc GF}
\input{7_Polynomial/Newton.tex}

\section{Geometry}
\subsection{Default Code}
\lstinputlisting{8_Geometry/GeometryDefaultFloat.h}
\subsection{PointSegDist*} % test by aizu oj CGL_2_D
...
\subsection{Trapezoidalization} % test by aizu CGL_3_C, TIOJ 1403
\lstinputlisting{8_Geometry/Trapezoidalization.cpp}
...
\section{Else}
\subsection{Cyclic Ternary Search*} % test by local brute force
\lstinputlisting{9_Else/cyc_tsearch.cpp}
